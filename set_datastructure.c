...
bool check_data(int set[], int data, int size){
  for(int i=0; i<size; i++)
    if(data==set[i])
      return true;
  return false;
...
void bitString(int u[], int set[], int bit[], int sizeU, int size){
...
void disp_bit(int set[], int size){
  for(int i=0; i< size; i++)
    printf("%d ", set[i]);
}

void set_union(int u[], int bit_a[], int bit_b[], int size){
  int bit_union[size];
  printf("\n{ ");
  for(int i=0; i<size; i++)
    if(bit_a[i]==1)
...
void set_intersection(int u[], int bit_a[],int bit_b[],int size){
  int bit_intr[size];
  printf("\n{ ");
  for(int i=0; i<size; i++)
    if(bit_a[i]==1)
...
void set_difference(int u[], int bit_a[], int bit_b[], int size){
  int bit_diff[size];
  printf("\n{ ");
  for(int i=0; i<size; i++)
    if(bit_a[i]==1)
